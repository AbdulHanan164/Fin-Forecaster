...
def scrape_announcements(symbol: str) -> list:
    """
    Scrape company announcements from PSX.
    Returns a list of dicts: [{ date, time, symbol, company, title, pdf_link }, ...]
    """
    ...
    try:
        ...
        print(f"Announcements Scrape Error: {e}")
        return []
    ...
    for row in rows:
        ...
        # PDF link is in the last column, first <a> tag usually
